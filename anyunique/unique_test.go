...
func TestSet_Make_BasicEquality(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_ZeroValue(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_StructPointers(t *testing.T) {
	...
	// The setd pointer should be the first one encountered
...
func TestSet_Make_IntValues(t *testing.T) {
...
func TestSet_Make_MultipleValues(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_HashCollisions(t *testing.T) {
...
func TestSet_WriteHash(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_WriteHash_ZeroValue(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_NilPointers(t *testing.T) {
	s := anyunique.New[*node](nodeHasher{})
...
func TestSet_Make_RepeatedCalls(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_DifferentSets(t *testing.T) {
	...
	// Values from different sets should not be comparable in practice,
	// but technically they might compare equal if the underlying strings
	// are the same. The important thing is they're independent sets.
	qt.Assert(t, qt.Equals(u1.Value(), "hello"))
	qt.Assert(t, qt.Equals(u2.Value(), "hello"))

	// Hashes from different sets will be different due to different seeds
	var h1, h2 maphash.Hash
	h1.SetSeed(maphash.MakeSeed())
...
func TestSet_WriteHash_ConsistentWithMake(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_StressTest(t *testing.T) {
	s := anyunique.New[int](simpleIntHasher{})
	...
	// Verify all values are setd correctly and re-making gives equal results
	for i := 0; i < n; i++ {
		u := s.Make(i)
...
type treeHasher struct {
	childSet *anyunique.Set[*treeNode, treeHasher]
}
...
func TestSet_Make_NestedStructures(t *testing.T) {
...
func TestSet_Make_ZeroValueInt(t *testing.T) {
	s := anyunique.New[int](simpleIntHasher{})
...
func TestSet_WriteHash_DifferentSeeds(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_Make_LargeStructPointers(t *testing.T) {
	s := anyunique.New[*node](nodeHasher{})
...
func TestSet_Make_AlternatingPatterns(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
...
func TestSet_WriteHash_MultipleValues(t *testing.T) {
	s := anyunique.New[string](stringHasher{})
